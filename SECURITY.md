...
Instead, [report it privately here](https://github.com/eclipse-threadx/zonex/security/advisories/new) on GitHub
...
ZoneX has not published a release yet. Until it does, only the `main` branch is supported; report vulnerabilities against the latest commit.
